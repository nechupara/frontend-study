...
const buildJs = () => gulp.src(path.src.js).pipe(concat('main.js')).pipe(uglify()).pipe(gulp.dest(path.prod.js)).pipe(browserSync.stream())

const buildImgs = () => gulp.src(path.src.img).pipe(imagemin()).pipe(gulp.dest(path.prod.img))
