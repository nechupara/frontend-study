...
const enterField = document.getElementById("enter-counter") as HTMLElement;
const spaceField = document.getElementById("space-counter") as HTMLElement;
const backSpaceField = document.getElementById("backspace-counter") as HTMLElement;
