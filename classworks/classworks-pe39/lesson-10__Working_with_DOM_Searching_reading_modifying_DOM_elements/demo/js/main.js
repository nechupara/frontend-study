...
let getElementById = document.getElementById('header');
let getElementsByClassName = document.getElementsByClassName('section-featured');
let getElementsByName = document.getElementsByName('user-name');
let getElementsByTagName = document.getElementsByTagName('header');
let querySelector = document.querySelector('.section-featured');
let querySelectorAll = document.querySelectorAll('.image-item');
...
console.log( imageItems.childNodes ); // списко того что входит в селектор
console.log( imageItems.children ); // надет чилдрены в селекторе
console.log( imageItems.firstChild ); // первый потомок node
console.log( imageItems.firstElementChild ); // надет первый чилдрен в селекторе
...
console.log('className', headerTitle.className );


console.log('classList', headerTitle.classList );

// headerTitle.classList.add('test');
// headerTitle.classList.remove('headerTitle');
// headerTitle.classList.replace('test', 'updated');
// headerTitleelem.classList.contains("headerTitle");
